...
class Form_Contas_List extends PRESTO_Forms
{
    public function __construct()
    {
        ...
        $titulo->setText( $this->translate("Lista de Contas"));
        ...
        $pagination->setTotalRecords((new ContasTable())->getTotalRecords(['count']));
        ...
        $btnAdd->setText($this->translate("Adicionar Nova Conta"));
