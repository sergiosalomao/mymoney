...
class Form_Usuarios_List extends PRESTO_Forms
{
    public function __construct()
    {
        #tituloUsuarios
        $titulo = new PRESTO_Components_Title('titulo');
        $titulo->setText( $this->translate("Lista de Usuarios"));
        ...
        $input_search->setTitle($this->translate("Digite o nome do usuario"));
        $input_search->setAction(APP_PATH . "/usuarios/");
        ...
        $pagination->setTotalRecords((new UsuariosTable())->getTotalRecords(['count']));
        ...
        $btnAdd->setText($this->translate("Adicionar Novo Usuario"));
