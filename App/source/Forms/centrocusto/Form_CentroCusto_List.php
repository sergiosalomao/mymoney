...
class Form_CentroCusto_List extends PRESTO_Forms
{
    public function __construct()
    {
        ...
        $titulo->setText( $this->translate("Lista de Centro Custo"));
        ...
        $input_search->setPlaceHolder($this->translate("Localizar por nome centro custo"));
        $input_search->setLabel($this->translate("Localizar"));
        $input_search->setMethod('post');
        $input_search->setClass('form-control');
        $input_search->setAction(APP_PATH . "/centro-custo/");
        ...
        $pagination->setTotalRecords((new CentroCustoTable())->getTotalRecords(['count']));
        ...
        $btnAdd->setText($this->translate("Adicionar Novo Centro Custo"));
