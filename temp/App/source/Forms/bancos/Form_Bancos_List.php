...
class Form_Bancos_List extends PRESTO_Forms
{
    public function __construct()
    {
        ...
        $titulo->setText( $this->translate("Lista de Bancos"));
        ...
        $pagination->setTotalRecords((new BancosTable())->getTotalRecords(['count']));
        ...
        $btnAdd->setText($this->translate("Adicionar Novo Banco"));
