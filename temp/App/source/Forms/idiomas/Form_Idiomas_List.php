...
class Form_Idiomas_List extends PRESTO_Forms
{
    public function __construct()
    {
        #tituloIdiomas
        $titulo = new PRESTO_Components_Title('titulo');
        $titulo->setText( $this->translate($this->translate("Lista de Idiomas")));
        ...
        $input_search->setPlaceHolder($this->translate("Localizar por descricao idioma"));
        $input_search->setLabel($this->translate("Localizar"));
        $input_search->setMethod('post');
        $input_search->setClass('form-control');
        $input_search->setTitle($this->translate('Digite a descricao do idioma.'));
        $input_search->setAction(APP_PATH . "/idiomas/");
        ...
        $pagination->setTotalRecords((new IdiomasTable())->getTotalRecords(['count']));
        ...
        $btnAdd->setText($this->translate('Adicionar Idioma'));
        $btnAdd->setTitle($this->translate('Adiciona uma novo idioma ao sistema'));
